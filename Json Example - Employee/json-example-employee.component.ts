...
@Component({
  selector: 'app-json-example-employee',
  templateUrl: './json-example-employee.component.html',
  styleUrls: ['./json-example-employee.component.css']
})
export class JsonExampleEmployeeComponent implements OnInit {
